...
// Demo password - in production this would be environment variable
const DEMO_PASSWORD = 'ValeDemo2025';
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const session = sessionStorage.getItem('vale-admin-auth');
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (password === DEMO_PASSWORD) {
      setIsAuthenticated(true);
      sessionStorage.setItem('vale-admin-auth', 'authenticated');
      setPasswordError('');
    } else {
  ...
  const handleLogout = () => {
    ...
    sessionStorage.removeItem('vale-admin-auth');
  };
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#002147] to-[#001530] flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          {/* Logo */}
          <div className="text-center mb-8">
            <div className="w-16 h-16 bg-white rounded-xl flex items-center justify-center mx-auto mb-4">
              <span className="text-[#002147] font-bold text-2xl">VS</span>
            </div>
            <h1 className="text-2xl font-bold text-white">Project Lead Hub</h1>
            <p className="text-gray-400 mt-1">Vale Southern Construction</p>
          </div>

          {/* Login Card */}
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            <div className="flex items-center justify-center w-12 h-12 bg-[#002147]/10 rounded-xl mx-auto mb-6">
              <Lock className="h-6 w-6 text-[#002147]" />
            </div>

            <h2 className="text-xl font-semibold text-[#002147] text-center mb-2">
              Secure Access
            </h2>
            <p className="text-sm text-gray-500 text-center mb-6">
              Enter the demo password to access the admin dashboard
            </p>
            ...
            <form onSubmit={handleLogin}>
              <div className="mb-4">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#002147] focus:border-transparent pr-12"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                className="w-full py-3 bg-[#002147] text-white font-medium rounded-lg hover:bg-[#003366] transition-colors flex items-center justify-center"
              >
            ...
            <div className="mt-6 pt-6 border-t border-gray-100">
              <p className="text-xs text-gray-400 text-center">
                This is a demonstration environment for Vale Southern Construction.
                <br />
